...
<body>
    ...
    <div class="container dangky w-50 shadow bg-success border-1 text-white">
        <h1>ĐĂNG NHẬP</h1>
        <form method="POST" action="dangnhapbt.php" name="dangnhap">
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <span class="float-end"><a href="#" class="dropdown-item ">Quên mật khẩu?</a></span>
        ...
        <a href="dangnhap.php" class="dropdown-item text-center mt-3">Chưa có tài khoản? Đăng ký</a>
    </div>
