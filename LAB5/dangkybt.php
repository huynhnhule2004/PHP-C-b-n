...
<body>
    ...
    <div class="container dangky w-50 bg-success border-1 text-white shadow">
        <h1>ĐĂNG KÝ TÀI KHOẢN</h1>
        <form method="POST" action="dangkytkbt.php" name="dangky">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <div class="form-check">
                   ...
                   <span class="float-end"> <a href="#" class="dropdown-item text-center">Quên mật khẩu</a></span>
        ...
        <a href="dangnhap.php" class="dropdown-item text-center mt-3">Đã có tài khoản? Đăng nhập</a>
    </div>
