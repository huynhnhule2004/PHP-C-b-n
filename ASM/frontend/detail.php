            ...
            <div class="content container w-75 mt-5">
                ...
                <div class="row">
                    <div class="col shadow-none">
                        <img class="img-fluid" src="../img/<?php echo $k['hinhAnh']; ?>" alt="">
                    </div>
                    <div class="col shadow-none">
                        ...
                        <form action="">
                            ...
                            <div class="buy">
                                <button>
                                    <a href="index.php?page=cartActive" class="text-decoration-none text-white">
                                ...
                                <button>
                                    <a href="../frontend/dathang.php" class="text-decoration-none text-white">
