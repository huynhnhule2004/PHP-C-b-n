...
<body>
  ...
  <div class="content container w-25 mt-3">
    <div class="user">
      <form action="" class="p-3" method="POST" action="index.php?page=sign-in" name="sign-in">
        ...
        <input type="submit" class="btn form-control" value="Đăng nhập">
        <p><a href="forgot-password.php">Quên mật khẩu?</a> hoặc <a href="index.php?page=sign-up">Đăng ký</a></p>
        <p><a href="../backend/index.php">Đăng nhập Admin</a></p>
      </form>
    </div>
