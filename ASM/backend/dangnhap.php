            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <a href="../frontend/index.php"><img class="img-fluid" src="../img/logo.webp" alt=""></a>
                        </div>
                    </div>
                    <div class="col">
            ...
            <ul class="nav d-flex justify-content-center ">
                ...
                <li class="nav-item list-shop">
                  ...
                  <ul class="dropdown-menu border-0 p-0 border-raidu">
                    ...
                    <li class="nav-item"><a href="" class="nav-link">POLO</a></li>
                  </ul>
                </li>
        ...
        <div class="content container w-25 mt-3">
            <div class="user">
                <form action="" class="p-3">
                    ...
                    <p><a href="forgot-password.html">Quên mật khẩu?</a> hoặc <a href="sign-up.html">Đăng ký</a></p>
                </form>
            </div>
